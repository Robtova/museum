...
public class PlaqueC extends Plaque {

	public PlaqueC() {
		artist = "Joseph Mallord William Turner";
		born = "Born London, England";
		title = "Lecture Diagram 54: Perspective Construction of a Corinthian Capital";
		year = "c.1810";
	...
	public void render(SpriteBatch batch) {
		...
		batch.draw(Art.paper, -w / 2 + 30, -h / 2 + 280, w - 60, 1.5f);
		batch.setColor(Color.WHITE);
		
		Art.arial_b_i.drawWrapped(batch, title, -w / 2 + 30, -h / 2 + 140, w - 60);
		Art.arial.draw(batch, year, -w / 2 + 30, -h / 2 + 210);
		Art.arial.draw(batch, medium, -w / 2 + 30, -h / 2 + 245);
		
		Art.arial.drawWrapped(batch, script, -w / 2 + 30, -h / 2 + 300, w - 60);
